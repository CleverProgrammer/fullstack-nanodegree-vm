...
menuItem2 = MenuItem(
    name="Peking Duck",
    description="A famous duck dish from Beijing[1] that has been prepared since\
     the imperial era. The meat is prized for its thin, crisp skin,\
     with authentic versions of the dish serving mostly the\
     skin and little meat, sliced in front of the\
     diners by the cook", price="$25", course="Entree", restaurant=restaurant2)
                     ...
                     description="a Japanese noodle soup dish. It\
                      consists of Chinese-style wheat noodles served in\
                       a meat- or (occasionally) fish-based broth, often\
                        flavored with soy sauce or miso, and uses\
                         toppings such as sliced pork, dried seaweed, kamaboko, and green onions.",
                     price="12", course="Entree", restaurant=restaurant2)
